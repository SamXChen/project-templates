...
const { getBundlesWebpackConfig } = require('./webpack-config/webpack.config.js')

const { getEntries: getSPAEntries } = require('./webpack-config/utils')
const { SPAModulesPath } = require('./webpack-config/path')
const { getDevServerConfig } = require('./webpack-config/dev-server')

const customEntry = require('./webpack-config/custom-entry')

const { ENV } = require('./webpack-config/const')
